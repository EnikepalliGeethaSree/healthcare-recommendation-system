...
TARGET = "diet_plan"
SAVE_DIR = "models/diet_models"
RESULTS_FILE = "models/diet_results.json"
...
# Save label encoder
pickle.dump(label_encoder, open(f"{SAVE_DIR}/diet_label_encoder.pkl", "wb"))
...
models = {
    ...
    "XGBoost": XGBClassifier(
        n_estimators=150, max_depth=12, learning_rate=0.1, eval_metric="mlogloss"
    ),
